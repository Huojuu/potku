...
class Selection:
    ...
    def draw(self):
        ...
        #self.axes.fill(self.points, zorder=1, fill=False,
        #                  color='orange')
        pointlist = self.get_points()
        midpoint_coord = self.calculate_midpoints(pointlist)

        for el in pointlist:
            self.axes.plot(el[0], el[1])  # some backgroung
